                        ...
                        <div className="team-item bg-white mb-4">
                            <div className="team-img position-relative overflow-hidden">
                                ...
                                <div className="team-social">
                                    <a className="btn btn-outline-primary btn-square" href="/.index.html"><i class="fa-solid fa-info"></i></a>
                                    <a className="btn btn-outline-info btn-square" href="/.index.html"><i class="fa-regular fa-pen-to-square"></i></a>
                                    <a className="btn btn-outline-danger btn-square" href="/.index.html"><i class="fa-solid fa-trash"></i></a>                                </div>
                            </div>
